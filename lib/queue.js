...
var Queue = module.exports = Channel.extend({
  init: function Queue (connection, channel, name, options, callback) {
    Channel.prototype.init.call(this, connection, channel);
